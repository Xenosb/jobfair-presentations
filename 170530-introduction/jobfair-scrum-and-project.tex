		...
		\begin{figure}
			\resizebox{!}{.7\textheight}{
				\begin{ganttchart}{1}{24}
					...
					\ganttbar{Web development}{2}{15} \ganttnewline
					\ganttbar{Backend development}{2}{15} \ganttnewline
					\ganttbar{Mobile development}{8}{15} \ganttnewline
					\ganttmilestone{Development freeze}{15} \ganttnewline
